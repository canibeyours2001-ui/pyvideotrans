...
be changed in the manual dispatch form. Kaggle internet access is enabled only
because the worker must install dependencies, download the Whisper model, and
